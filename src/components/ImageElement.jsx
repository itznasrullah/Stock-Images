    ...
    return (
        <div className='ImageElement'  >
            ...
            <div className='overlay'>
                <svg className={ liked ? 'liked' : '' } xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 32 32" enableBackground="new 0 0 32 32" id="Stock_cut" version="1.1" onClick={() => setLiked(!liked)} ><desc /><path d="M28.343,17.48L16,29  L3.657,17.48C1.962,15.898,1,13.684,1,11.365v0C1,6.745,4.745,3,9.365,3h0.17c2.219,0,4.346,0.881,5.915,2.45L16,6l0.55-0.55  C18.119,3.881,20.246,3,22.465,3h0.17C27.255,3,31,6.745,31,11.365v0C31,13.684,30.038,15.898,28.343,17.48z" fill='none' stroke="#fff" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2" /></svg>
                
                <svg className='download-btn' xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none" onClick={e => download(props.src)}>
